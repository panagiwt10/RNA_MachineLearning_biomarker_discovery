...
* **Log-Transformed PCA (`pca_log.png`):** By applying a log transformation before PCA, we normalize the high dynamic range of RNA-seq counts. This emphasizes biological fold-changes over absolute count differences, typically resulting in much clearer separation between cancer types.
* **Sammon Mapping (`sammon_mapping.png`):** Unlike PCA, this is a non-linear dimensionality reduction technique that specifically attempts to preserve the relative distances between all pairs of samples. It is highly effective for revealing complex local structures that linear methods might overlook.

**Visual Comparison:**
<img src="images/pca_1st.png" width="300" alt="Initial PCA"> <img src="images/log_pca.png" width="300" alt="Log PCA"> <img src="images/sammon_map.png" width="300" alt="Sammon Map">**
